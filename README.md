...
- 版本号：1.4.0
- 状态：MP6 填写 AppID 前最终收口版
- 正式学校数据：55 条
- 历史录取分数线：103 条
- 数据核对日期：2026-07-06
- 当前已收录 2025 官方历史分数线：是
- 当前暂未收录 2026 年学校级录取分数线
- 运行方式：用户填写真实 AppID 后，用微信开发者工具导入本目录并编译
- AppID：仓库内保持 `touristappid`，真实 AppID 由用户在本机填写
...
用户仍需手动填写真实 AppID、编译、真机预览、上传开发版本、设置体验版、添加体验成员、提交微信审核，并在审核通过后发布。Codex 不能替用户登录微信公众平台、上传体验版或提交审核。
