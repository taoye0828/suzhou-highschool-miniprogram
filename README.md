...
面向苏州初中学生和家长的纯本地高中信息、成绩记录和目标规划工具。当前版本为 RC9（`1.9.0`），不登录、不接后台或云开发、不使用 AI、不上传用户数据。
...
- 首页个人总览、学校库实用筛选、学校详情、收藏和 1 至 3 校对比。
- 成绩记录、总分/学科趋势、确定性个人分析、考试复盘和可选排名。
- 推荐、目标学校分级、主要目标、差距轨迹及完整阶段学习目标。
