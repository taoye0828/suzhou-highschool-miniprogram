...
assert.ok(pageJs.includes('context.fillText('))
assert.ok(pageJs.includes("point.trendMetric === 'rate'"))
assert.ok(pageJs.includes('String(point.score)'))
...
assert.ok(pageJs.includes('labelStyle: `left: ${point.leftPercent}%'))
assert.ok(pageWxml.includes('style="{{item.labelStyle}}"'))
